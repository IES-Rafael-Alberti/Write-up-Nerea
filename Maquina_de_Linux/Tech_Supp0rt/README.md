...
get enter.txt
```
![enter](Maquinas_de_Windows/Tech_Supp0rt/imagenes/descargarenter.png)
...
cat enter.txt
```
![cat](Maquinas_de_Windows/Tech_Supp0rt/imagenes/catenter.png)
...
```
![base](Maquinas_de_Windows/Tech_Supp0rt/imagenes/base.png)
...
```
![url](Maquinas_de_Windows/Tech_Supp0rt/imagenes/login.png)
...
```
![search](Maquinas_de_Windows/Tech_Supp0rt/imagenes/search.png)
...
```
![search](Maquinas_de_Windows/Tech_Supp0rt/imagenes/searchsploit.png)
...
![python](Maquinas_de_Windows/Tech_Supp0rt/imagenes/python2.png)
...
```
![ls](Maquinas_de_Windows/Tech_Supp0rt/imagenes/ls.png)
...
```bash
 ...
 ![ls](Maquinas_de_Windows/Tech_Supp0rt/imagenes/mysql.png)
...
El acceso fue exitoso, obteniendo una shell interactiva en el sistema.
 ...
 ![ssh](Maquinas_de_Windows/Tech_Supp0rt/imagenes/ssh.png)
...
```
 ...
 ![root](Maquinas_de_Windows/Tech_Supp0rt/imagenes/root.png)
