...
```
![nmap](Maquina_de_Linux/Tech_Supp0rt/imagenes/nmap.png)
...
```
![SMBCLIENT](Maquina_de_Linux/Tech_Supp0rt/imagenes/smbclient.png)
...
```
![websvr](Maquina_de_Linux/Tech_Supp0rt/imagenes/websvr.png)
...
root@TechSupport:~#
```
 ![root](Maquina_de_Linux/Tech_Supp0rt/imagenes/root2.png)
